...
window.iniciarTelemetria3D = async function() {
    ...
    try {
        ...
        fetch('//unpkg.com/three-globe/example/data/ne_110m_admin_0_countries.geojson').then(r => r.json()).then(countries => { world.polygonsData(countries.features).polygonCapColor(() => 'rgba(15, 23, 42, 0.6)').polygonSideColor(() => 'rgba(56, 189, 248, 0.15)') .polygonStrokeColor(() => 'rgba(56, 189, 248, 0.4)'); }).catch(e => console.error(e));
